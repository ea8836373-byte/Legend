...
local Window = WindUI:CreateWindow({
    Title = "BestHub|Legends Of Speed",
    Icon = "zap",
...
AboutActions:Button({
    ...
    Callback = function()
        local info = [[
BestHub|Legends Of Speed v6.0.0
Framework: WindUI
Created: May 12, 2026
Lines: 1700+
Developer: Kyo Yt - Sulfrax discord
...
task.delay(1, function()
    Notify("Welcome!", "BestHub|Legends Of Speed 6.0.0 Loaded!", "zap", 5)
